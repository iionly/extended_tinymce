...
An extended tinymce plugin based on the jquery version 4.6.5 of the TinyMCE editor. This release of the Extended Tinymce plugin is for Elgg 2.3 and newer Elgg 2.X.
