Elgg Extended Tinymce plugin for Elgg 1.9+1.10
...
An extended tinymce plugin based on the jquery version 4.1.8 of the TinyMCE editor. This release of the Extended Tinymce plugin is for Elgg 1.9/1.10 only.
