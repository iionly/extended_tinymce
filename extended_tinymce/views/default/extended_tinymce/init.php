...
$(document).ready(function(){
	$(".elgg-input-longtext").tinymce({
		...
		plugins: "advlist autolink charmap code emoticons hr image insertdatetime link lists paste preview print searchreplace table textcolor wordcount",
		menubar: false,
		toolbar_items_size: "small",
		toolbar1: "newdocument preview print | searchreplace | styleselect | fontselect | fontsizeselect",
